...
type HourlyProps = {
	...
	index: number;
	setIsHourly: Dispatch<SetStateAction<boolean>>;
	setIndex: Dispatch<SetStateAction<number>>
}

const Hourly: React.FC<HourlyProps> = ({ setIsHourly, item, forecast, index, setIndex }) => {
	const wrapperRef = React.useRef<HTMLDivElement>(null);

	React.useEffect(() => {
		//===закрытие окна houry при клике вне его===========================================================================================
		const onClickOutsideHourly = (e: MouseEvent) => {
